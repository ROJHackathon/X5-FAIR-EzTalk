...
## Usage
Our product can be accessed with the following URL *https://rojhackathon.github.io/Front-end-EzTalk/* with internet browsers. For best experience, it is recommended to access with IOS mobile phones
